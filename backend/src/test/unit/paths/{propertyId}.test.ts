import operations from "../../../api/v1/paths/properties/{propertyId}";
 ...
 * i.e. when new methods are added to /properties/{propertyId} path
 */
describe("/properties/{propertyId} Path Object", () => {
